...
public class PedestalMenu extends AbstractContainerMenu {
    public final PedestalBlockEntity blockEntity; // Access the block entity
    ...
    public PedestalMenu(int pContainerId, Inventory inv, BlockEntity blockEntity) {
        ...
        // Index 0, the first slot | xPosition 80 = 80 pixels left & yPosition 35 = 35 pixels down, getting you to the top left corner of the slot
    ...
    // Make sure the player doesn't walk away from the block
    @Override
    ...
    // Pretty much always use these to tell which slots are inventory and block slots
